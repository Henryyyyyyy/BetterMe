...
public class ProfileRowView extends BaseRowView implements View.OnClickListener {
    ...
    private RowProfileDescriber mDescriber;
    ...
    private void initializeView() {
        LayoutInflater.from(mContext).inflate(R.layout.widget_profile_row_view, this);
    ...
    public void initializeData(BaseRowDescriber describer) {
        this.mDescriber= (RowProfileDescriber) describer;
    }
